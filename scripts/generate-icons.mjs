 ...
 *   android/…/res/mipmap-anydpi-v26/ic_launcher*.xml     — adaptive icon defs (white background layer)
...
async function main() {
  ...
  if (!existsSync(RES)) {
    console.log(
      'ℹ android/ platform not found — favicon only. Run `npx cap add android`, then re-run.',
    );
    return;
  }
